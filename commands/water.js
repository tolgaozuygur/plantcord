...
var waterCommandCounter = 0;

module.exports.execute = (client, message) => {
  if (waterCommandCounter < config.waterCommandCounter) {
    embed.addField(this.info.field + waterCommandCounter - config.waterCommandCounter + "more need command", this.info.moisture_low + " - " + this.info.moisture_high + " " + this.info.recommended_moisture)
    waterCommandCounter++;
